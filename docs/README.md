...
| 17 | [HERNE wearable](architecture/17-herne-wearable.md) | Thryve-ready wearable layer — real pipeline, mock data source |
...
- **Phase 3** — the AI management platform + admin portal + user dashboard (shipped): agent/prompt/knowledge management, playground, safety, memory, analytics — all DB-driven and admin-managed. No live AI at that stage (mocked, "build once, configure forever").
- **Phase 4** — refocus the product around the customer journey (shipped): the **Receptionist AI** front door, **Specialist AI** subscription products, and an **AI-centric CRM**, reusing all Phase 2–3 infrastructure. Still mocked at that stage (no live AI/payments).
