  ...
  return (
    <div className="mx-auto flex max-w-6xl flex-col gap-8">
      <AdminHeader
        ...
        description="Run your AI business at a glance — the receptionist, your specialist AIs, subscriptions and leads. Prototype figures are illustrative."
      />

      <StatGrid>
        <StatCard label="Specialist AIs" value={s?.specialists ?? 0} icon={Bot} />
        <StatCard label="Active subscribers" value={s ? s.activeSubscribers.toLocaleString() : '—'} icon={Users} trend={{ value: '+8%', direction: 'up' }} />
