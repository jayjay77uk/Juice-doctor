...
const policies: SafetyPolicy[] = [
  {
    ...
    allowedTopics: ['general enquiries', 'account help', 'product information', 'onboarding', 'billing', 'the framework'],
    restrictedTopics: ['legal advice', 'financial advice', 'sensitive personal data'],
    medicalBoundaries: [
  ...
  },
  {
    ...
    allowedTopics: ['operational guidance', 'summaries', 'framework interpretation'],
    restrictedTopics: ['approvals'],
    medicalBoundaries: ['Defer all final judgement to the practitioner'],
    emergencyResponses: {},
